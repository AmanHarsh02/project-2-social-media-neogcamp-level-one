...
export function PageWrapper({ children }) {
  ...
  return (
    <div
      ...
      className="flex flex-row justify-around h-screen bg-gray-200 dark:bg-gray-800   gap-4 p-4 md:px-4 lg:px-16 w-screen grow relative overflow-y-auto [&::-webkit-scrollbar]:hidden"
    >
