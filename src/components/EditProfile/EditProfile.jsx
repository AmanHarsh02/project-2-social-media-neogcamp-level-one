        ...
        <div className="relative self-center">
          <div className="w-[10rem] sm:w-[14rem] md:w-[18rem] shrink-0 overflow-hidden p-4">
            ...
            <div
              ...
              className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 cursor-pointer bg-slate-200 dark:bg-slate-500 hover:bg-slate-300 dark:hover:bg-slate-600 w-max p-2 rounded-full shadow-md"
            >
              <MediaIcon className="w-[1.2rem] h-[1.2rem] md:w-[1.5rem] md:h-[1.5rem]" />
            </div>
          </div>
          ...
          {showImageOption && (
            <div className="absolute -bottom-[4.5rem] -right-[1rem] sm:right-[1rem] md:right-[3rem] w-max bg-slate-200 dark:bg-slate-500 rounded-lg shadow-lg overflow-hidden">
              <label className="flex gap-1 items-center cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-600 p-2">
                <input
                  type="file"
