...
export function PostCard({ post, showComment }) {
  ...
  return (
    <div className="relative h-max flex flex-col gap-4 bg-white dark:bg-gray-600 p-2 shadow-md border border-slate-300 dark:border-none rounded-xl overflow-hidden">
      <section>
